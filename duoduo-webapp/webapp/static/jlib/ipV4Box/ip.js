...
IpV4Box.prototype={
    ...
    */
    ...
    toString:function(){
        return '<span style="border:1px solid #ccc;background:transparent;display: inline-block;" id="'+this.id+'" >\
            <input style="border:0px solid #ccc;text-align:center;" onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" type="text" size=3 id="'+this.id+'_1" maxlength=3\
            />.<input style="border:0px;text-align:center;" onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" type="text" size=3 id="'+this.id+'_2" maxlength=3\
            />.<input style="border:0px;text-align:center;" onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" type="text" size=3 id="'+this.id+'_3" maxlength=3\
            />.<input style="border:0px;text-align:center;"onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" type="text" size=3 id="'+this.id+'_4" maxlength=3/>\
        </span>';
    },
    getValue:function(){
        if(document.getElementById(this.id+"_1").value=="") document.getElementById(this.id+"_1").value=0;
        if(document.getElementById(this.id+"_2").value=="") document.getElementById(this.id+"_2").value=0;
        if(document.getElementById(this.id+"_3").value=="") document.getElementById(this.id+"_3").value=0;
        if(document.getElementById(this.id+"_4").value=="") document.getElementById(this.id+"_4").value=0;
        var ip=[
...
IpV4Box.evt={
    ...
    keydown:function(obj,evt){
        ...
        case 37://left
            ...
            break;
        case 39://right
            if(pos.end==value.length && index<4)
            {
                id=id.replace(/(\d)$/,parseInt(index)+1 );
                document.getElementById(id).focus();
                document.getElementById(id).select();
