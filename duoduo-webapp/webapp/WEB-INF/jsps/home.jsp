...
<div style="display:none">
	<div id="modifyUserWrapper">
		<div class="modifyUser-content mo-dialog-content w400h470">
			<div class="title">
				...
				<input type="hidden" id="oldPhone" name="oldPhone" value="${currentUser.user.phone}"/>
				<input type="hidden" id="oldEmail" name="oldEmail" value="${currentUser.user.email }"/>
				<input type="hidden" id="oldOfficeLocation" name="oldOfficeLocation" value=""/>
			</div>
			...
			<div class="info clearfix">
				...
				<div class="setting-item">
					...
					<div class="setting-item-main">
						<input type="text" id="phone" name="phone" class="input-text" value="${currentUser.user.phone }" />
					</div>
				</div>
				<div class="setting-item">
				...
				<div class="setting-item">
					...
					<div class="setting-item-main">
						<input type="text" id="officeLocation" name="officeLocation" class="input-text" value="" />
					</div>
				</div>
				<div class="item-msg">
					<div class="msg"></div>
	...
	<div id="modifyPasswordWrapper">
		<div class="modifyPassword-content mo-dialog-content w400h300">
			<div class="title">
	...
	<div id="logoutWrapper">
		<div class="logout-content mo-dialog-content w400h300">
			<div class="title">
				<span>退出系统</span>
				<a href="javascript:void(0);" class="W_close" hidefocus="true"></a>
			</div>
