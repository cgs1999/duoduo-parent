...
import com.duoduo.system.manager.RoleResourceManager;
...
public class RoleServiceImpl implements RoleService {
	...
	public RoleVO create(RoleVO roleVO) {
		...
		// 保存角色权限关系
		roleResourceManager.saveOrUpdate("" + role.getId(), roleVO.getResourceIds());
	...
	public void update(RoleVO roleVO) {
		...
		// 更新角色权限关系
		roleResourceManager.saveOrUpdate("" + roleVO.getId(), roleVO.getResourceIds());
	}
	...
	public boolean delete(String id) {
		...
		// 删除角色权限关系
		roleResourceManager.deleteByRoleId(id);
